...
ParticleSpectrum[K1*CD[-b][A23Field[d,-c,-d]]*CD[c][A23Field[a,-a,b]]+K2*CD[-c][A23Field[d,-b,-d]]*CD[c][A23Field[a,-a,b]]-(3*K1*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-a,-c,d]])/2-(3*K2*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-a,-c,d]])/2-(3*K1*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-c,-a,d]])/2-(3*K2*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-c,-a,d]])/2+K7*CD[c][A23Field[a,-a,b]]*CD[-d][A23Field[-c,-b,d]],TheoryName->"A23B1D3F3H1I2",Method->"Hard",ShowPropagator->True,AspectRatio->Portrait,MaxLaurentDepth->1];
Quit[];