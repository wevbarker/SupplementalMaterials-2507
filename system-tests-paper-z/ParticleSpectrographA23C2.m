...
ParticleSpectrum[M1*A23Field[-a,-b,-c]*A23Field[a,b,c]+M1*A23Field[a,b,c]*A23Field[-b,-a,-c]+M3*A23Field[a,-a,b]*A23Field[c,-b,-c]+K1*CD[-b][A23Field[d,-c,-d]]*CD[c][A23Field[a,-a,b]]+K2*CD[-c][A23Field[d,-b,-d]]*CD[c][A23Field[a,-a,b]]+K3*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-a,-c,d]]+K4*CD[-a][A23Field[a,b,c]]*CD[-d][A23Field[-b,-c,d]]-2*K15*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-c,-a,d]]+2*K16*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-c,-a,d]]+K3*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-c,-a,d]]-(K4*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-c,-a,d]])/2+K7*CD[c][A23Field[a,-a,b]]*CD[-d][A23Field[-c,-b,d]]-K15*CD[-a][A23Field[a,b,c]]*CD[-d][A23Field[d,-b,-c]]+K16*CD[-a][A23Field[a,b,c]]*CD[-d][A23Field[d,-b,-c]]-(K4*CD[-a][A23Field[a,b,c]]*CD[-d][A23Field[d,-b,-c]])/2+K15*CD[-d][A23Field[-a,-b,-c]]*CD[d][A23Field[a,b,c]]+K16*CD[-d][A23Field[-b,-a,-c]]*CD[d][A23Field[a,b,c]],TheoryName->"A23C2",Method->"Hard",ShowPropagator->True,AspectRatio->Portrait,MaxLaurentDepth->1];
Quit[];