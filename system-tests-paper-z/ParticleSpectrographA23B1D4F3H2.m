...
ParticleSpectrum[M3*A23Field[a,-a,b]*A23Field[c,-b,-c]+K1*CD[-b][A23Field[d,-c,-d]]*CD[c][A23Field[a,-a,b]]+K2*CD[-c][A23Field[d,-b,-d]]*CD[c][A23Field[a,-a,b]]+(11*K15*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-a,-c,d]])/6+(4*K15*CD[-a][A23Field[a,b,c]]*CD[-d][A23Field[-b,-c,d]])/3+(7*K15*CD[-b][A23Field[a,b,c]]*CD[-d][A23Field[-c,-a,d]])/6-3*K15*CD[c][A23Field[a,-a,b]]*CD[-d][A23Field[-c,-b,d]]-(2*K15*CD[-a][A23Field[a,b,c]]*CD[-d][A23Field[d,-b,-c]])/3+K15*CD[-d][A23Field[-a,-b,-c]]*CD[d][A23Field[a,b,c]]+K15*CD[-d][A23Field[-b,-a,-c]]*CD[d][A23Field[a,b,c]],TheoryName->"A23B1D4F3H2",Method->"Hard",ShowPropagator->True,AspectRatio->Portrait,MaxLaurentDepth->1];
Quit[];